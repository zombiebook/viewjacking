...
namespace enemyviewjack
{
    ...
    public class EnemyViewJackController : MonoBehaviour
    {
            ...
            private bool _playerRbCanSetVelocity;
            ...
            private void StartJack()
            {
                ...
                _playerRbCanSetVelocity = (_playerRb != null && !_playerRb.isKinematic);
            ...
            private void FreezePlayer()
            {
                ...
                // 키네마틱이 아닌 리지드바디만 속도 0으로
                if (_playerRbCanSetVelocity && _playerRb != null)
                {
